...
// CHECK-NEXT:     llvm.store %arg0, %9 : i32, !llvm.ptr
// CHECK-NEXT:     llvm.store %arg1, %10 : i32, !llvm.ptr
...
// CHECK-NEXT:       %12 = llvm.icmp "slt" %11, %4 : i32
// CHECK-NEXT:       llvm.cond_br %12, ^bb5, ^bb7
// CHECK-NEXT:     ^bb2:  // pred: ^bb5
// CHECK-NEXT:       clift.loop {
// CHECK-NEXT:         llvm.br ^bb1
// CHECK-NEXT:       ^bb1:  // pred: ^bb0
// CHECK-NEXT:         %19 = llvm.load %9 : !llvm.ptr -> i32
// CHECK-NEXT:         %20 = llvm.icmp "eq" %19, %5 : i32
// CHECK-NEXT:         llvm.cond_br %20, ^bb4, ^bb2
// CHECK-NEXT:       ^bb2:  // pred: ^bb1
// CHECK-NEXT:         %21 = llvm.load %10 : !llvm.ptr -> i32
// CHECK-NEXT:         %22 = llvm.call @printf(%7, %21) : (!llvm.ptr, i32) -> i32
// CHECK-NEXT:         %23 = llvm.load %10 : !llvm.ptr -> i32
// CHECK-NEXT:         %24 = llvm.icmp "eq" %23, %8 : i32
// CHECK-NEXT:         llvm.cond_br %24, ^bb3, ^bb5
...
// CHECK-NEXT:       llvm.br ^bb2
// CHECK-NEXT:     ^bb6:  // 2 preds: ^bb3, ^bb4
// CHECK-NEXT:       %15 = llvm.load %9 : !llvm.ptr -> i32
// CHECK-NEXT:       %16 = llvm.add %15, %3  : i32
// CHECK-NEXT:       llvm.store %16, %9 : i32, !llvm.ptr
// CHECK-NEXT:       %17 = llvm.load %10 : !llvm.ptr -> i32
// CHECK-NEXT:       %18 = llvm.add %17, %3  : i32
// CHECK-NEXT:       llvm.store %18, %10 : i32, !llvm.ptr
