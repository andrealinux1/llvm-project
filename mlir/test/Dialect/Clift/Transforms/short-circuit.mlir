...
// CHECK-COMB-NEXT:     %6 = llvm.load %4 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:     %7 = llvm.icmp "slt" %6, %1 : i32
// CHECK-COMB-NEXT:     llvm.cond_br %7, ^bb8, ^bb9
// CHECK-COMB-NEXT:   ^bb1:  // pred: ^bb8
// CHECK-COMB-NEXT:     %8 = llvm.load %5 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:     %9 = llvm.icmp "slt" %8, %1 : i32
// CHECK-COMB-NEXT:     llvm.cond_br %9, ^bb6, ^bb7
// CHECK-COMB-NEXT:   ^bb2:  // pred: ^bb6
// CHECK-COMB-NEXT:     %10 = llvm.load %4 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:     %11 = llvm.call @printf(%3, %10) : (!llvm.ptr, i32) -> i32
// CHECK-COMB-NEXT:     %12 = llvm.load %4 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:     %13 = llvm.add %12, %0  : i32
// CHECK-COMB-NEXT:     llvm.store %13, %4 : i32, !llvm.ptr
// CHECK-COMB-NEXT:     llvm.br ^bb5
// CHECK-COMB-NEXT:   ^bb3:  // pred: ^bb9
// CHECK-COMB-NEXT:     %14 = llvm.load %5 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:     %15 = llvm.call @printf(%3, %14) : (!llvm.ptr, i32) -> i32
// CHECK-COMB-NEXT:     %16 = llvm.load %5 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:     %17 = llvm.add %16, %0  : i32
// CHECK-COMB-NEXT:     llvm.store %17, %5 : i32, !llvm.ptr
// CHECK-COMB-NEXT:     llvm.br ^bb5
// CHECK-COMB-NEXT:   ^bb4:  // pred: ^bb7
// CHECK-COMB-NEXT:     %18 = llvm.load %5 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:     %19 = llvm.call @printf(%3, %18) : (!llvm.ptr, i32) -> i32
// CHECK-COMB-NEXT:     %20 = llvm.load %5 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:     %21 = llvm.add %20, %0  : i32
// CHECK-COMB-NEXT:     llvm.store %21, %5 : i32, !llvm.ptr
// CHECK-COMB-NEXT:     llvm.br ^bb5
// CHECK-COMB-NEXT:   ^bb5:  // 3 preds: ^bb2, ^bb3, ^bb4
...
// CHECK-COMB-NEXT:   ^bb8:  // pred: ^bb0
// CHECK-COMB-NEXT:     llvm.br ^bb1
// CHECK-COMB-NEXT:   ^bb9:  // pred: ^bb0
