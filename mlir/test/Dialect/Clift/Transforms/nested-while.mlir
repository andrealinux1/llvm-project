...
// RUN: mlir-opt -restructure-clift %s | FileCheck %s -check-prefix=CHECK-COMB
...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>>} {
  ...
  ^bb2:  // pred: ^bb1
    ...
    %10 = llvm.call @printf(%4, %9) : (!llvm.ptr, i32) -> i32
...
// CHECK-COMB-NEXT:     %2 = llvm.mlir.constant(1 : i32) : i32
// CHECK-COMB-NEXT:     %3 = llvm.mlir.constant(0 : i32) : i32
// CHECK-COMB-NEXT:     %4 = llvm.mlir.constant(10 : i32) : i32
// CHECK-COMB-NEXT:     %5 = llvm.mlir.constant("%d\00") : !llvm.array<3 x i8>
// CHECK-COMB-NEXT:     %6 = llvm.mlir.addressof @".str" : !llvm.ptr
// CHECK-COMB-NEXT:     %7 = llvm.alloca %2 x i32 {alignment = 4 : i64} : (i32) -> !llvm.ptr
// CHECK-COMB-NEXT:     %8 = llvm.alloca %2 x i32 {alignment = 4 : i64} : (i32) -> !llvm.ptr
// CHECK-COMB-NEXT:     llvm.store %3, %7 : i32, !llvm.ptr
// CHECK-COMB-NEXT:     llvm.store %3, %8 : i32, !llvm.ptr
...
// CHECK-COMB-NEXT:       %10 = llvm.icmp "slt" %9, %4 : i32
// CHECK-COMB-NEXT:       llvm.cond_br %10, ^bb3, ^bb5
// CHECK-COMB-NEXT:     ^bb2:  // pred: ^bb3
// CHECK-COMB-NEXT:       clift.loop {
// CHECK-COMB-NEXT:         llvm.br ^bb1
// CHECK-COMB-NEXT:       ^bb1:  // pred: ^bb0
// CHECK-COMB-NEXT:         %15 = llvm.load %8 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:         %16 = llvm.icmp "slt" %15, %4 : i32
// CHECK-COMB-NEXT:         llvm.cond_br %16, ^bb2, ^bb3
// CHECK-COMB-NEXT:       ^bb2:  // pred: ^bb1
// CHECK-COMB-NEXT:         %17 = llvm.load %8 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:         %18 = llvm.call @printf(%6, %17) : (!llvm.ptr, i32) -> i32
// CHECK-COMB-NEXT:         %19 = llvm.load %8 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:         %20 = llvm.add %19, %2  : i32
// CHECK-COMB-NEXT:         llvm.store %20, %8 : i32, !llvm.ptr
...
// CHECK-COMB-NEXT:       } ^bb4
// CHECK-COMB-NEXT:     ^bb3:  // pred: ^bb1
// CHECK-COMB-NEXT:       %11 = llvm.load %7 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:       %12 = llvm.call @printf(%6, %11) : (!llvm.ptr, i32) -> i32
// CHECK-COMB-NEXT:       %13 = llvm.load %7 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:       %14 = llvm.add %13, %2  : i32
// CHECK-COMB-NEXT:       llvm.store %14, %7 : i32, !llvm.ptr
// CHECK-COMB-NEXT:       llvm.br ^bb2
// CHECK-COMB-NEXT:     ^bb4:  // pred: ^bb2
