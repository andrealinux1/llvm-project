...
// CHECK-RESTRUCTURE-NEXT:     %6 = llvm.mlir.constant(5 : i32) : i32
// CHECK-RESTRUCTURE-NEXT:     %7 = llvm.alloca %3 x i32 {alignment = 4 : i64} : (i32) -> !llvm.ptr
// CHECK-RESTRUCTURE-NEXT:     %8 = llvm.alloca %3 x i32 {alignment = 4 : i64} : (i32) -> !llvm.ptr
// CHECK-RESTRUCTURE-NEXT:     llvm.store %arg0, %7 : i32, !llvm.ptr
// CHECK-RESTRUCTURE-NEXT:     llvm.store %arg1, %8 : i32, !llvm.ptr
...
// CHECK-RESTRUCTURE-NEXT:       %10 = llvm.call @printf(%5, %9) : (!llvm.ptr, i32) -> i32
// CHECK-RESTRUCTURE-NEXT:       llvm.br ^bb2
// CHECK-RESTRUCTURE-NEXT:     ^bb2:  // pred: ^bb1
// CHECK-RESTRUCTURE-NEXT:       clift.loop {
// CHECK-RESTRUCTURE-NEXT:         llvm.br ^bb1
// CHECK-RESTRUCTURE-NEXT:       ^bb1:  // pred: ^bb0
// CHECK-RESTRUCTURE-NEXT:         %11 = llvm.load %8 : !llvm.ptr -> i32
// CHECK-RESTRUCTURE-NEXT:         %12 = llvm.call @printf(%5, %11) : (!llvm.ptr, i32) -> i32
// CHECK-RESTRUCTURE-NEXT:         llvm.br ^bb4
// CHECK-RESTRUCTURE-NEXT:       ^bb2:  // pred: ^bb3
// CHECK-RESTRUCTURE-NEXT:         %13 = llvm.load %8 : !llvm.ptr -> i32
// CHECK-RESTRUCTURE-NEXT:         %14 = llvm.icmp "eq" %13, %6 : i32
// CHECK-RESTRUCTURE-NEXT:         llvm.cond_br %14, ^bb5, ^bb7
// CHECK-RESTRUCTURE-NEXT:       ^bb3:  // pred: ^bb4
// CHECK-RESTRUCTURE-NEXT:         llvm.br ^bb2
// CHECK-RESTRUCTURE-NEXT:       ^bb4:  // pred: ^bb1
// CHECK-RESTRUCTURE-NEXT:         %15 = llvm.load %7 : !llvm.ptr -> i32
// CHECK-RESTRUCTURE-NEXT:         %16 = llvm.icmp "eq" %15, %6 : i32
// CHECK-RESTRUCTURE-NEXT:         llvm.cond_br %16, ^bb6, ^bb3
...
// CHECK-RESTRUCTURE-NEXT:       ^bb7:  // pred: ^bb2
// CHECK-RESTRUCTURE-NEXT:         clift.goto %1 !clift.label
// CHECK-RESTRUCTURE-NEXT:       ^bb8:  // pred: ^bb5
// CHECK-RESTRUCTURE-NEXT:         "clift.continue"() : () -> ()
// CHECK-RESTRUCTURE-NEXT:       } ^bb3, ^bb4
...
// CHECK-COMB-NEXT:     %6 = llvm.mlir.constant(5 : i32) : i32
// CHECK-COMB-NEXT:     %7 = llvm.alloca %3 x i32 {alignment = 4 : i64} : (i32) -> !llvm.ptr
// CHECK-COMB-NEXT:     %8 = llvm.alloca %3 x i32 {alignment = 4 : i64} : (i32) -> !llvm.ptr
// CHECK-COMB-NEXT:     llvm.store %arg0, %7 : i32, !llvm.ptr
// CHECK-COMB-NEXT:     llvm.store %arg1, %8 : i32, !llvm.ptr
...
// CHECK-COMB-NEXT:       %9 = llvm.load %7 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:       %10 = llvm.call @printf(%5, %9) : (!llvm.ptr, i32) -> i32
// CHECK-COMB-NEXT:       llvm.br ^bb2
// CHECK-COMB-NEXT:     ^bb2:  // pred: ^bb1
// CHECK-COMB-NEXT:       clift.loop {
// CHECK-COMB-NEXT:         llvm.br ^bb1
// CHECK-COMB-NEXT:       ^bb1:  // pred: ^bb0
// CHECK-COMB-NEXT:         %11 = llvm.load %8 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:         %12 = llvm.call @printf(%5, %11) : (!llvm.ptr, i32) -> i32
// CHECK-COMB-NEXT:         llvm.br ^bb4
// CHECK-COMB-NEXT:       ^bb2:  // pred: ^bb3
// CHECK-COMB-NEXT:         %13 = llvm.load %8 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:         %14 = llvm.icmp "eq" %13, %6 : i32
// CHECK-COMB-NEXT:         llvm.cond_br %14, ^bb5, ^bb7
// CHECK-COMB-NEXT:       ^bb3:  // pred: ^bb4
// CHECK-COMB-NEXT:         llvm.br ^bb2
// CHECK-COMB-NEXT:       ^bb4:  // pred: ^bb1
// CHECK-COMB-NEXT:         %15 = llvm.load %7 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:         %16 = llvm.icmp "eq" %15, %6 : i32
// CHECK-COMB-NEXT:         llvm.cond_br %16, ^bb6, ^bb3
// CHECK-COMB-NEXT:       ^bb5:  // pred: ^bb2
// CHECK-COMB-NEXT:         llvm.br ^bb8
// CHECK-COMB-NEXT:       ^bb6:  // pred: ^bb4
// CHECK-COMB-NEXT:         clift.goto %2 !clift.label
// CHECK-COMB-NEXT:       ^bb7:  // pred: ^bb2
// CHECK-COMB-NEXT:         clift.goto %1 !clift.label
// CHECK-COMB-NEXT:       ^bb8:  // pred: ^bb5
// CHECK-COMB-NEXT:         "clift.continue"() : () -> ()
// CHECK-COMB-NEXT:       } ^bb3, ^bb4
