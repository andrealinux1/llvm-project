...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>>} {
  ...
  llvm.func @foo(%arg0: i32, %arg1: i32, %arg2: i32) attributes {passthrough = ["noinline", "nounwind", ["uwtable", "2"], ["frame-pointer", "all"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"], ["target-features", "+cx8,+fxsr,+mmx,+sse,+sse2,+x87"], ["tune-cpu", "generic"]]} {
  ...
  ^bb2:  // pred: ^bb1
    ...
    %12 = llvm.icmp "slt" %11, %1 : i32
    llvm.cond_br %12, ^bb3, ^bb4
  ^bb3:  // pred: ^bb2
    %13 = llvm.load %4 : !llvm.ptr -> i32
    %14 = llvm.call @printf(%3, %13) : (!llvm.ptr, i32) -> i32
  ...
  ^bb4:  // 3 preds: ^bb0, ^bb1, ^bb2
    ...
    %18 = llvm.call @printf(%3, %17) : (!llvm.ptr, i32) -> i32
...
// CHECK-RESTRUCTURE-NEXT:   llvm.func @foo(%arg0: i32, %arg1: i32, %arg2: i32) attributes {passthrough = ["noinline", "nounwind", ["uwtable", "2"], ["frame-pointer", "all"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"], ["target-features", "+cx8,+fxsr,+mmx,+sse,+sse2,+x87"], ["tune-cpu", "generic"]]} {
...
// CHECK-RESTRUCTURE-NEXT:     %7 = llvm.load %4 : !llvm.ptr -> i32
// CHECK-RESTRUCTURE-NEXT:     %8 = llvm.icmp "slt" %7, %1 : i32
// CHECK-RESTRUCTURE-NEXT:     llvm.cond_br %8, ^bb1, ^bb4
// CHECK-RESTRUCTURE-NEXT:   ^bb1:  // pred: ^bb0
// CHECK-RESTRUCTURE-NEXT:     %9 = llvm.load %5 : !llvm.ptr -> i32
// CHECK-RESTRUCTURE-NEXT:     %10 = llvm.icmp "slt" %9, %1 : i32
// CHECK-RESTRUCTURE-NEXT:     llvm.cond_br %10, ^bb2, ^bb4
// CHECK-RESTRUCTURE-NEXT:   ^bb2:  // pred: ^bb1
// CHECK-RESTRUCTURE-NEXT:     %11 = llvm.load %6 : !llvm.ptr -> i32
// CHECK-RESTRUCTURE-NEXT:     %12 = llvm.icmp "slt" %11, %1 : i32
// CHECK-RESTRUCTURE-NEXT:     llvm.cond_br %12, ^bb3, ^bb4
// CHECK-RESTRUCTURE-NEXT:   ^bb3:  // pred: ^bb2
// CHECK-RESTRUCTURE-NEXT:     %13 = llvm.load %4 : !llvm.ptr -> i32
// CHECK-RESTRUCTURE-NEXT:     %14 = llvm.call @printf(%3, %13) : (!llvm.ptr, i32) -> i32
// CHECK-RESTRUCTURE-NEXT:     %15 = llvm.load %4 : !llvm.ptr -> i32
// CHECK-RESTRUCTURE-NEXT:     %16 = llvm.add %15, %0  : i32
// CHECK-RESTRUCTURE-NEXT:     llvm.store %16, %4 : i32, !llvm.ptr
// CHECK-RESTRUCTURE-NEXT:     llvm.br ^bb5
// CHECK-RESTRUCTURE-NEXT:   ^bb4:  // 3 preds: ^bb0, ^bb1, ^bb2
// CHECK-RESTRUCTURE-NEXT:     %17 = llvm.load %5 : !llvm.ptr -> i32
// CHECK-RESTRUCTURE-NEXT:     %18 = llvm.call @printf(%3, %17) : (!llvm.ptr, i32) -> i32
// CHECK-RESTRUCTURE-NEXT:     %19 = llvm.load %5 : !llvm.ptr -> i32
// CHECK-RESTRUCTURE-NEXT:     %20 = llvm.add %19, %0  : i32
// CHECK-RESTRUCTURE-NEXT:     llvm.store %20, %5 : i32, !llvm.ptr
// CHECK-RESTRUCTURE-NEXT:     llvm.br ^bb5
// CHECK-RESTRUCTURE-NEXT:   ^bb5:  // 2 preds: ^bb3, ^bb4
...
// CHECK-COMB-NEXT:   llvm.func @foo(%arg0: i32, %arg1: i32, %arg2: i32) attributes {passthrough = ["noinline", "nounwind", ["uwtable", "2"], ["frame-pointer", "all"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"], ["target-features", "+cx8,+fxsr,+mmx,+sse,+sse2,+x87"], ["tune-cpu", "generic"]]} {
// CHECK-COMB-NEXT:     %0 = llvm.mlir.constant(1 : i32) : i32
// CHECK-COMB-NEXT:     %1 = llvm.mlir.constant(10 : i32) : i32
// CHECK-COMB-NEXT:     %2 = llvm.mlir.constant("%d\00") : !llvm.array<3 x i8>
// CHECK-COMB-NEXT:     %3 = llvm.mlir.addressof @".str" : !llvm.ptr
...
// CHECK-COMB-NEXT:     %7 = llvm.load %4 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:     %8 = llvm.icmp "slt" %7, %1 : i32
// CHECK-COMB-NEXT:     llvm.cond_br %8, ^bb12, ^bb13
// CHECK-COMB-NEXT:   ^bb1:  // pred: ^bb12
// CHECK-COMB-NEXT:     %9 = llvm.load %5 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:     %10 = llvm.icmp "slt" %9, %1 : i32
// CHECK-COMB-NEXT:     llvm.cond_br %10, ^bb10, ^bb11
// CHECK-COMB-NEXT:   ^bb2:  // pred: ^bb10
// CHECK-COMB-NEXT:     %11 = llvm.load %6 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:     %12 = llvm.icmp "slt" %11, %1 : i32
// CHECK-COMB-NEXT:     llvm.cond_br %12, ^bb8, ^bb9
// CHECK-COMB-NEXT:   ^bb3:  // pred: ^bb8
// CHECK-COMB-NEXT:     %13 = llvm.load %4 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:     %14 = llvm.call @printf(%3, %13) : (!llvm.ptr, i32) -> i32
// CHECK-COMB-NEXT:     %15 = llvm.load %4 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:     %16 = llvm.add %15, %0  : i32
// CHECK-COMB-NEXT:     llvm.store %16, %4 : i32, !llvm.ptr
// CHECK-COMB-NEXT:     llvm.br ^bb7
// CHECK-COMB-NEXT:   ^bb4:  // pred: ^bb13
// CHECK-COMB-NEXT:     %17 = llvm.load %5 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:     %18 = llvm.call @printf(%3, %17) : (!llvm.ptr, i32) -> i32
// CHECK-COMB-NEXT:     %19 = llvm.load %5 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:     %20 = llvm.add %19, %0  : i32
// CHECK-COMB-NEXT:     llvm.store %20, %5 : i32, !llvm.ptr
// CHECK-COMB-NEXT:     llvm.br ^bb7
// CHECK-COMB-NEXT:   ^bb5:  // pred: ^bb11
// CHECK-COMB-NEXT:     %21 = llvm.load %5 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:     %22 = llvm.call @printf(%3, %21) : (!llvm.ptr, i32) -> i32
// CHECK-COMB-NEXT:     %23 = llvm.load %5 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:     %24 = llvm.add %23, %0  : i32
// CHECK-COMB-NEXT:     llvm.store %24, %5 : i32, !llvm.ptr
// CHECK-COMB-NEXT:     llvm.br ^bb7
// CHECK-COMB-NEXT:   ^bb6:  // pred: ^bb9
// CHECK-COMB-NEXT:     %25 = llvm.load %5 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:     %26 = llvm.call @printf(%3, %25) : (!llvm.ptr, i32) -> i32
// CHECK-COMB-NEXT:     %27 = llvm.load %5 : !llvm.ptr -> i32
// CHECK-COMB-NEXT:     %28 = llvm.add %27, %0  : i32
// CHECK-COMB-NEXT:     llvm.store %28, %5 : i32, !llvm.ptr
// CHECK-COMB-NEXT:     llvm.br ^bb7
// CHECK-COMB-NEXT:   ^bb7:  // 4 preds: ^bb3, ^bb4, ^bb5, ^bb6
// CHECK-COMB-NEXT:     llvm.return
// CHECK-COMB-NEXT:   ^bb8:  // pred: ^bb2
// CHECK-COMB-NEXT:     llvm.br ^bb3
// CHECK-COMB-NEXT:   ^bb9:  // pred: ^bb2
// CHECK-COMB-NEXT:     llvm.br ^bb6
// CHECK-COMB-NEXT:   ^bb10:  // pred: ^bb1
// CHECK-COMB-NEXT:     llvm.br ^bb2
// CHECK-COMB-NEXT:   ^bb11:  // pred: ^bb1
// CHECK-COMB-NEXT:     llvm.br ^bb5
// CHECK-COMB-NEXT:   ^bb12:  // pred: ^bb0
// CHECK-COMB-NEXT:     llvm.br ^bb1
// CHECK-COMB-NEXT:   ^bb13:  // pred: ^bb0
